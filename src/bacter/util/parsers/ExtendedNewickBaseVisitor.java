...
/**
 * This class provides an empty implementation of {@link ExtendedNewickVisitor},
 ...
 */
public class ExtendedNewickBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements ExtendedNewickVisitor<T> {
	/**
	 * {@inheritDoc}
	 *
